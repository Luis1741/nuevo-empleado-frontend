...
export const crearAcceso = (data: { nombre: string }) =>
  axios.post(`${API}/crear`, data);
export const actualizarAcceso = (id: number, data: { nombre: string }) =>
...
export const obtenerSolicitudesAcceso = () =>
  axios.get(`${API}/listar-solicitud`);
export const cambiarEstadoSolicitud = (id: number, estado: string) =>
