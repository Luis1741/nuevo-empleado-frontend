      ...
      <form onSubmit={handleSubmit} className="card p-4 mt-4">
        ...
        <div className="mb-2">
          ...
          <label>
            Listado de Accesos:{" "}
            <b>
              (Si deseas eliminar o actualizar el acceso de doble clic sobre el
              nombre)
            </b>
          </label>
          <br />
                  ...
                  {editAccesoId === acceso.id ? (
                    <>
                      <input
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Enter")
                            handleGuardarEditarAcceso(acceso.id);
                    ...
                    <label
                      ...
                      onDoubleClick={() =>
                        handleEditarAcceso(acceso.id, acceso.nombre)
                      }
